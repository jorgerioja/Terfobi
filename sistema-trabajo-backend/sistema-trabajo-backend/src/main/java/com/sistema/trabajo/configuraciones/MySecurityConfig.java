...
public class MySecurityConfig extends  WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.OPTIONS).permitAll()//método utilizado para las opciones de
        //comunicacion para el recurso de destino. Muy usado en CORS para validar si el servidor
        //acepta peticiones de diferentes orígenes.
